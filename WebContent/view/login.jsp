	...
	<div class="container card-4 b-r-sm" style="overflow: hidden;">
		...
		<div class="row">
			<div class="col-md-5  p-5">
				<h4 class="text-info mb-5  text-center" >Bonsai 3</h4>
					<!-- heading main -->
					...
					<c:if test="${not empty error1}">
					  ...
					  <div class="row">
					  	...
					  	<div class="row mt-2">
					  	<div class="col">
					  		<button type="submit" onclick="location.href='showPage.html'" class="btn btn-primary " style="width: 100%; " >Sign Up</button>
					  	</div>
			...
			<div class="col-md-7" style="padding-right: 0;">
				<img src="Images\photo-HD.jpg" width="100%" height="525px" style="object-fit: cover; object-position:bottom;">
			</div>
		</div>
	</div>
	</div>
