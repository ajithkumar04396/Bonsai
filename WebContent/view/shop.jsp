		...
		<div class="container p-5 mt-5">
			...
			<div class="row mt-3">
				...
				<div class="col-sm-4 text-right">
					 <div class="dropdown">
    					<button class="btn btn-primary" type="button" onclick="location.href='canpage.html'">Sort by plant</button>
  						<button class="btn btn-primary" type="button" onclick="location.href='bottlepage.html'">Sort by services</button>
  					</div>
				</div>
			</div>
			<hr>
				...
				<div class="col-md-9">
					...
					<c:forEach var="listValue" items="${list}">
						...
						<div class="col-md-3 card-1 p-1 m-3 text-center" style="height: 100%">
							<img src="Images/${listValue.productimage}" height="120px" width="120px">
