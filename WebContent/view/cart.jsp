    ...
    <tbody>
      ...
      <tr>
        <td><button type="button" class="close p-3" aria-label="Close">
  				<span aria-hidden="true" style="color:red;"><a style="color:red; text-decoration:none;" href="cartdell.html?id=${listValue.product_id}&amp;st=${listValue.quality}">&times;</a></span>
				</button></td>
        <td><img src="Images/${listValue.productimage}" height="60px"; width="60px";></td>
