	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-7">
						<img src="Images/${listValue.productimage}" style="padding: 10%;"  width="80%"; height="80%";>
					</div>
					<div class="col-md-5">
					...
					<input type="hidden" name="productprice" value="${listValue.productprice}">
						...
						<p style="color: red;">Delivery only within Bangalore.</p>
						<label style="color:grey;">Select the Total order</label><br>
						<input class="mb-2" type="number" id="quality"  required name="quality" min="0" max="${listValue.stock}">
						<c:choose><c:when test="${listValue.stock ge 1}"> <h5 style="color: blue;">Stock Available: ${listValue.stock}</h5>
						<p>Product will be delivered only in locations we are available.</p></c:when>
						<c:otherwise><span id="hide" ><h5>Out of stock</h5></span></c:otherwise></c:choose>
